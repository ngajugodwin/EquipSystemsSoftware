...
namespace ItemBookingApp_API.Migrations
{
    ...
    [Migration("20230624131015_RemoveRequiredFromShippingPrice")]
    partial class RemoveRequiredFromShippingPrice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemBookingApp_API.Domain.Models.BasketItem", b =>
                {
                    ...
                    b.HasKey("ItemId", "CustomerBasketId");
            ...
            modelBuilder.Entity("ItemBookingApp_API.Domain.Models.CustomerBasket", b =>
                {
                    b.HasOne("ItemBookingApp_API.Domain.Models.Identity.AppUser", "User")
                        .WithOne("CustomerBasket")
                        .HasForeignKey("ItemBookingApp_API.Domain.Models.CustomerBasket", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ItemBookingApp_API.Domain.Models.OrderAggregate.Order", b =>
                {
                    b.HasOne("ItemBookingApp_API.Domain.Models.OrderAggregate.DeliveryMethod", "DeliveryMethod")
                        .WithMany()
            ...
            modelBuilder.Entity("ItemBookingApp_API.Domain.Models.OrderAggregate.OrderItem", b =>
                {
                    b.HasOne("ItemBookingApp_API.Domain.Models.OrderAggregate.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
            ...
            modelBuilder.Entity("ItemBookingApp_API.Domain.Models.Organisation", b =>
                {
                    b.HasOne("ItemBookingApp_API.Domain.Models.Identity.AppUser", "ApprovedByUser")
                        .WithMany("ApprovedByUser")
